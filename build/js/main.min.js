...
/* harmony import */ var _modules_visibility__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/visibility */ "./js/modules/visibility.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_visibility__WEBPACK_IMPORTED_MODULE_3__["changeVisibility"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_phone_mask__WEBPACK_IMPORTED_MODULE_5__["getPhoneMask"])();
  });
}); // ---------------------------------
...
var btns = document.querySelectorAll('.footer__button');
  ...
  try {
    var _loop = function _loop() {
      ...
      btn.addEventListener('click', function () {
        var activeBtns = document.querySelectorAll('.footer__button--active');

        if (btn.classList.contains('footer__button--active')) {
          var _iterator2 = _createForOfIteratorHelper(activeBtns),
              _step2;

          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var activeBtn = _step2.value;
          ...
          var _iterator3 = _createForOfIteratorHelper(activeBtns),
              _step3;

          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
              var _activeBtn = _step3.value;

              _activeBtn.classList.remove('footer__button--active');
            }
          } catch (err) {
            _iterator3.e(err);
          } finally {
...
/*!**********************************!*\
  !*** ./js/modules/visibility.js ***!
  \**********************************/
/*! exports provided: changeVisibility */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var changeVisibility = function changeVisibility() {
  var buttons = document.querySelectorAll('.btn-full');
  ...
  try {
    var _loop = function _loop() {
      ...
      var elementClass = button.dataset.visibilityClass;
      var elements = document.querySelectorAll(".".concat(elementClass));
      var elementsMobile = document.querySelectorAll(".".concat(elementClass, "-tablet"));
      elements.forEach(function (el) {
        el.classList.add("".concat(elementClass, "--closed"));
      });
      elementsMobile.forEach(function (el) {
        el.classList.add("".concat(elementClass, "-tablet--closed"));
      });
      button.addEventListener('click', function () {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            if (element.classList.contains("".concat(elementClass, "--closed"))) {
              element.classList.remove("".concat(elementClass, "--closed"));
              element.classList.add("".concat(elementClass, "--opened"));
              button.innerHTML = 'Свернуть';
              elementsMobile.forEach(function (el) {
                el.classList.remove("".concat(elementClass, "-tablet--closed"));
                el.classList.add("".concat(elementClass, "-tablet--opened"));
              });
            } else {
              element.classList.add("".concat(elementClass, "--closed"));
              element.classList.remove("".concat(elementClass, "--opened"));
              button.innerHTML = 'Подробнее';
              elementsMobile.forEach(function (el) {
                el.classList.remove("".concat(elementClass, "-tablet--opened"));
                el.classList.add("".concat(elementClass, "-tablet--closed"));
              });
            }
          }
