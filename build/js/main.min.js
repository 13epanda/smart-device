...
var btns = document.querySelectorAll('.footer_button');
  ...
  try {
    var _loop = function _loop() {
      ...
      btn.addEventListener('click', function () {
        var activeBtns = document.querySelectorAll('.footer_button--active');
        ...
        if (btn.classList.contains('footer_button--active')) {
          ...
          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
              ...
              _activeBtn.classList.remove('footer_button--active');
            }
          } catch (err) {
            _iterator3.e(err);
          } finally {
